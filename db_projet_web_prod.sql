...
--
-- Hôte : localhost:8889
-- Généré le : mer. 24 mai 2023 à 05:27
...
(1, 'admin', 'admin', 'default.jpg', 1, '2023-04-13 20:36:26', NULL, '2023-05-23 20:23:18'),
(2, 'Remi', 'remi', '1684779904image.png', 4, '2023-04-13 20:36:26', '2023-05-22 20:25:04', '2023-05-24 07:25:51'),
(3, 'Charles-Augustin', 'charlesaugustin', 'default.jpg', 4, '2023-04-13 20:36:26', NULL, '2023-05-24 07:23:41');
...
--
ALTER TABLE `favorites_movies`
  ADD CONSTRAINT `favorites_movies_ibfk_1` FOREIGN KEY (`movieID`) REFERENCES `movies` (`id`),
